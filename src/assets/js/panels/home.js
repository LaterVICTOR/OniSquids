...
class Home {
    ...
    async initLaunch() {
        document.querySelector('.play-btn').addEventListener('click', async () => {
            ...
            launch.on('patch', patch => {
                console.log(patch);
                info.innerHTML = `parche en proceso...`
            });
    ...
    async initStatusServer() {
        ...
        if (!serverPing.error) {
            ...
            serverMs.innerHTML = `<span class="red">línea de Oro</span>`;
        }
    }
    ...
    async getdate(e) {
        ...
        let allMonth = ['Enero', 'Febreo', 'Marso', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre']
